...
def test_build_path_state():
    ...
    expected_path = os.path.join(site, "president/general/2024/california/trump-vs-harris")
    assert build_path(site, poll_type, jurisdiction) == expected_path
...
def test_main(mock_pour_soup):
    ...
    mock_pour_soup.assert_called_once_with(os.path.join(sitename, "president/general/2024/trump-vs-harris"))